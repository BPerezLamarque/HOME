...
##  Step 1-C:  OTU clustering (at 97%)

vsearch -cluster_size  reads_16S_sorted.fa --id 0.97 --centroids reads_16S_OTU_97.fa --uc clusters_16S_97.uc  --sizein --sizeout


# Make file that mapped reads to OTUs
python3 map2qiime.py clusters_16S_97.uc > reads_16S_mapped_OTU97.txt # python script map2qiime.py available in https://github.com/BPerezLamarque/HOME/blob/master/tutorial_HOME/map2qiime.py
...
# Make stats file
python3 make_stats.py reads_16S_OTU_97_final.fa > stats_16S_OTU97.txt # python script make_stats.py available in https://github.com/BPerezLamarque/HOME/blob/master/tutorial_HOME/make_stats.py
